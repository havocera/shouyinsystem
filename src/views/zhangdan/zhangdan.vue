					...
					<div class="cart">
						<el-card class="box-card">
							...
							<div>
								...
								<div class="goods">
									<div>
										<div v-for="(qiutaiitem, qiutaiindex) in data.zhangdan.qiutai"
											:key="qiutaiindex">
					...
					<div class="cart">
						<el-card class="box-card">
							...
							<div>
								...
								<div class="goods">
									<div v-for="(qiutaiitem, qiutaiindex) in data.zhangdan.foodzhangdan"
										:key="qiutaiindex">
			...
			<template #default>
				<div>
					<el-checkbox-group @change="getchange" v-model="data.qiutaiList" size="large">
						<el-checkbox v-for="(item,index) in data.qiutai" :label="`桌号：${item.number}`" size="large"
							border />
					</el-checkbox-group>
				</div>
			</template>
				...
				<el-form :model="data.balance" label-width="120px">
					...
					<el-form-item label="会员账户">
						<el-select-v2 size="large" v-model="data.balance.vip" value-key="phone_number" filterable remote
							:remote-method="getVip" @change="getbalance" clearable :options="data.vipList" :loading="loading"
							placeholder="请输入手机号码" />
