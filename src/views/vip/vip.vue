...
<template>
	<div>
		<el-card class="box-card">
			<template #header>
				<div class="card-header">
					<span></span>
					<el-row :gutter="5">
						<el-col :span="6"><el-input style="vertical-align: middle;" v-model="data.vip"
								@input="handleSearch" size="large" placeholder="手机号搜索" :suffix-icon="Search" /></el-col>
			...
			<el-table :data="data.goodsList" border style="width: 100%" empty-text="暂无会员">
				...
				<!-- <el-table-column prop="registration_date" label="创建时间" /> -->
		...
		<el-drawer v-model="addvisible" :show-close="false">
			...
			<el-form :model="data.goodsform" ref="addForm" label-width="120px">
				...
				<el-form-item label="充值金额">
					<el-input-number v-model="data.goodsform.balance" :precision="2" :step="0.1" />
				</el-form-item>
				<el-form-item>
		...
		<el-drawer size="50%" v-model="getchongzhivisible" :show-close="false">
			...
			<el-descriptions title="" v-for="item in data.chongzhihistory" :key="item.id" :column="3" border>
				<el-descriptions-item label="金额" label-align="center"
				...
				<el-descriptions-item label="方式" label-align="center" width="150" align="center">{{item.type}}</el-descriptions-item>
			</el-descriptions>
		</el-drawer>
	</div>
</template>
